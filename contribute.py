...
def arguments(argsval):
    ...
    parser.add_argument('-mc', '--max_commits', type=int, default=15,
    ...
    parser.add_argument('-un', '--user_name', type=str, required=False, default="strike1031",
    ...
    parser.add_argument('-ue', '--user_email', type=str, required=False, default="strike10310522@gmail.com",
                        ...
                        If not specified, the global config is used.""")
    parser.add_argument('-da', '--days_ago', type=int, required=False, default=1060,
